...
#########################################################
    ...
    for line in infile:
        ...
        return_list = enhancer_classes.Enhancer_find.find_TF(putative_enhancers, "Zelda180")
        for i in return_list:
            outputlist.append(i)
    print len(outputlist)
    output_output = enhancer_classes.Enhancer_compare(outputlist, "Zld_enhancer_sept1")
...
genes_to_check("/mnt/home/sonnens2/crm_analysis/datasets/enhancer_prediction_input_data/enhancer_prediction_input_files/target_genes.csv")
