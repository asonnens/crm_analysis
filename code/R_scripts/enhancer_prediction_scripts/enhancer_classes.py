...
class Enhancer_find:
    ...
    def cluster_TF(self, seed_TF, test_line):
        ...
        if len(my_feature_list) > 1:
            ...
            protein_weights = {"Zelda180":1000, "hb":1, "twi":1, "gt":1, "kr":1, "DorsalR":10, "cad":1, "kni":1, "sna":1, "bcd":1,\
                               ...
                               "kruppel":10,"knirps":10,"hunchback":10, "giant":10, "snail":10}
            my_coord_list = []
            my_weight_list = []
            distance_from_TSS = 0
            ...
            putative_enhancer_coord1 = midpoint - 750
            putative_enhancer_coord2 = midpoint + 750
    ...
    def print_bedfile(self, mylist):
        ...
        outfile_name = "/mnt/home/sonnens2/crm_analysis/output_data/enhancer_predictions_output" + \
    ...
    def find_TF(self, choose_protein = "dl"):
        ...
        for each_file in self.input_info:
            ...
            infile.close()
        print len(putative_enhancer_list)
        if len(putative_enhancer_list) > 0: 
            ...
            outlist = self.print_bedfile(merged_enhancer_list)
        return(outlist)
