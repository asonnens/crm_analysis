...
stark_all_comparison = enhancer_classes.Enhancer_compare(all_list, "Stark_reporters_all_noscale")
#stark_one_reporter_comparison = enhancer_classes.Enhancer_compare(one_list, "Stark_reporters_one_noscale")
stark_NA_reporter_comparison = enhancer_classes.Enhancer_compare(NA_list, "Stark_reporters_NA25")
