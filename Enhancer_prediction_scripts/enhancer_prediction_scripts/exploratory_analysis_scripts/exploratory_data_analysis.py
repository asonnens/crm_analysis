...
make_venn(input_directory, "bcd_1_chipchip.bedgraph", "bcd_2_chipchip.bedgraph", "Bcd_comparison", "Bcd chip 1", "Bcd chip 2", "green", "green", "darkgreen")
make_venn(input_directory, "dl_rushlow_chipseq.bedgraph", "dl_chipchip.bedgraph", "Dorsal_comparison", "Dl seq", "Dl chip", "#993333", "tomato", "red")
make_venn(input_directory, "hb_1_chipchip.bedgraph", "hb_2_chipchip.bedgraph", "Hb_comparison", "Hb chip 1", "Hb chip 2", "darkslateblue", "darkslateblue", "lightblue")
make_venn(input_directory, "hry_1_chipchip.bedgraph", "hry_2_chipchip.bedgraph", "Hry_comparison", "Hry chip 1", "Hry chip 2", "sienna", "sienna", "brown")
make_venn(input_directory, "Sna_1_chipchip.bedgraph", "Sna_2_chipchip.bedgraph", "Sna_comparison", "Sna chip 1", "Sna chip 2", "darkolivegreen", "darkolivegreen", "green")
make_venn(input_directory, "Twi_1_chipchip.bedgraph", "Twi_2_chipchip.bedgraph", "Twi_comparison", "Twi chip 1", "Twi chip 2", "dimgray", "dimgray", "black")
