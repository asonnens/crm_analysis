...
#of well defined enhancers, or prespective enhancers that were identified using
#clustering of different features, within the enhancer_classes.py script.
#It applies functions from the enhancer classes
