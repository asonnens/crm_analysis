...
file_stats("Zeitlinger_tw_chipseq.bedgraph", "twist_macarthur25.bedgraph", "Zeitlinger Macarthur twist files")
...
#each_file_stats("Zeitlinger_tw_chipseq.bedgraph", "crap")
